import{d8 as F,d9 as T,db as I,dd as d,dA as y,da as t,dC as k,ec as O,dx as _,dw as n}from"./app-Dvg1b3kT.js";import{h as q}from"./CopyToClipboard-DSTf_eKU-f_dWAb1q.js";import{n as B}from"./OpenLink-DZHy38vr-TRkhMiz3.js";import{C as A}from"./QrCode-BxAVhbx2-CPH3d7Hl.js";import{n as E}from"./ScreenLayout-Ce16-u0i-BXRDQ_r7.js";import{l as x}from"./farcaster-DPlSjvF5-MvuDVDmI.js";/* empty css             */import"./dijkstra-D_NXgYpA.js";import"./ModalHeader-YbJk-YIQ-CbtQ1oj-.js";import"./Screen-CdOj1bUg-0_23yI7A.js";import"./index-Dq_xe9dz-BCT8ZzsY.js";let S="#8a63d2";const M=({appName:u,loading:m,success:i,errorMessage:e,connectUri:r,onBack:s,onClose:c,onOpenFarcaster:o})=>t.jsx(E,k||m?O?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${u} to add casts, likes, follows, and more on your behalf.`,icon:x,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},primaryCta:r&&o?{label:"Open Farcaster app",onClick:o}:void 0,onBack:s,onClose:c,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:x,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},onBack:s,onClose:c,watermark:!0,children:r&&k&&t.jsx(P,{children:t.jsx(B,{text:"Take me to Farcaster",url:r,color:S})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${u} to add casts, likes, follows, and more on your behalf.`,onBack:s,onClose:c,watermark:!0,children:t.jsxs(R,{children:[t.jsx(L,{children:r?t.jsx(A,{url:r,size:275,squareLogoElement:x}):t.jsx(z,{children:t.jsx(_,{})})}),t.jsxs(N,{children:[t.jsx(V,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),r&&t.jsx(q,{text:r,itemName:"link",color:S})]})]})});let P=n.div`
  margin-top: 24px;
`,R=n.div`
  display: flex;
